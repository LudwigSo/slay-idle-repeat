...
/// <summary>One directed edge of a <see cref="Board"/>'s graph. Movement traverses one at a time.</summary>
...
/// </param>
/// <param name="Preview">Populated only on a <see cref="EdgeKind.Branch"/> edge; null otherwise.</param>
