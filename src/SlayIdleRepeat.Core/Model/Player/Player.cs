...
/// </para>
/// <para>
/// Deliberately absent: inventory, gear instances, the unopened-container shelf and lifetime feat
/// counters — each deferred with a <c>GapRegister</c> entry keyed on a type that must not yet exist,
