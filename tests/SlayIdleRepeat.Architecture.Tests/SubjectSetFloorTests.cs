...
public sealed class SubjectSetFloorTests
{
    ...
    private static readonly PendingSubject[] Pending =
    {
        ...
        new(Domain.RulesNamespace, SubjectKind.CoreNamespace, "M1-06",
        ...
        new(Domain.CommandsNamespace, SubjectKind.CoreNamespace, "M1-01",
            "AccessibilityBoundaryTests.Core_internal_layering_holds"),
        ...
        new(Domain.TestingNamespace, SubjectKind.CoreNamespace, "M1-08",
            "AccessibilityBoundaryTests.Core_internal_layering_holds"),
    };
