...
public sealed class ToolProjectAccountabilityTests
{
        ...
        offenders.AddRange(
            toolProjects
                ...
                .Select(name =>
                    ...
                    "register and nothing else in the repository) — whichever is true of it. Until then it " +
                    "may reference Application, or take a vendor package, with a green suite."));
    ...
    /// <summary>The register every manifest-consumer tool reads (M8-09).</summary>
