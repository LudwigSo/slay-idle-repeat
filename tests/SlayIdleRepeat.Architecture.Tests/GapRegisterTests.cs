...
public sealed class GapRegisterTests
{
    ...
    public void Every_deferred_command_names_a_task_the_tracker_declares()
    {
        ...
        owners.Length.ShouldBe(
            33,
            "14 §2.3's registry is 19 run + 30 meta, and 33 of the 49 rows are Deferred since M3-13 " +
            "landed the REVIVE/END_RUN/ABANDON_RUN handlers (beside M3-05's " +
            "START_BATTLE/CONFIRM_BATTLE_RESULT, M3-03's RESOLVE_TILE/EVENT_CHOOSE/CAMPFIRE_CHOOSE, " +
            "M3-02's CHOOSE_FORK, M3-08's SHOP_BUY/SHOP_REFRESH, M3-15's START_RUN, M3-03c's " +
        ...
        handled.ShouldBe(
            ...
            "closing a battle over Run's new RunPhase.BattlePending; and 02 §5-6's REVIVE, END_RUN " +
            "and ABANDON_RUN (M3-13) the fourteenth, fifteenth and sixteenth — reward banking and " +
