...
/// </para>
/// <para>
/// Not its own test project: <c>build/ci/test-suites.json</c> requires every <c>tests/*/*.csproj</c>
/// it discovers to contain tests, so this is linked (<c>&lt;Compile Include="..\Shared\*.cs" /&gt;</c>)
/// into whichever suites need it rather than shipped as its own empty-looking project.
/// </para>
/// </remarks>
