...
/// independent transcription whose FNV-1a 64 first reproduced Noll's published vectors. If a row
/// moves, every <c>stateHash</c> ever issued to a client moved with it, every client mirror stops
/// agreeing with the server, and the parity and reconnect tests start comparing fiction.
/// </remarks>
