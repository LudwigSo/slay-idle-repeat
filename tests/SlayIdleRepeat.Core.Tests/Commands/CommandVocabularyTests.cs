...
public sealed class CommandVocabularyTests
{
    ...
    public void Every_command_in_the_vocabulary_is_applied_and_refused_rather_than_thrown()
    {
        ...
        // lowered it again to 36 by START_BATTLE/CONFIRM_BATTLE_RESULT, and M3-06 lowers it again to
        // 33 by PICK_PERK/REROLL_DRAFT/SKIP_DRAFT. It is stated as "the registry
        // minus the handled rows" rather than as the literal 33 so the next task to land a handler
        ...
        deferred.ShouldBe(
            ...
            "every DEFERRED row of 14 §2.3 is driven here — 33 of the 49 since M3-06 landed the " +
            "PICK_PERK/REROLL_DRAFT/SKIP_DRAFT handlers. A mismatch means the loop skipped " +
        ...
        deferred.ShouldBe(
            ...
            "PICK_PERK/REROLL_DRAFT/SKIP_DRAFT (06 §1, M3-06) — have " +
