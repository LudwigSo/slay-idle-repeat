...
public sealed class CommandVocabularyTests
{
    ...
    public void Every_command_in_the_vocabulary_is_applied_and_refused_rather_than_thrown()
    {
        ...
        // by MINIGAME_SUBMIT, and M3-04 lowers it again to 44 by ROLL_DICE and USE_REROLL. It is
        // stated as "the registry minus the handled rows" rather than as the literal 44 so the next
        // task to land a handler lowers it by construction, and so the
        ...
        deferred.ShouldBe(
            ...
            "every DEFERRED row of 14 §2.3 is driven here — 44 of the 49 since M3-04 landed the " +
        ...
        deferred.ShouldBe(
            ...
            "is 49 rows and exactly five of them — BEGIN_SESSION (30 §2.3's day cycle), START_RUN " +
            "(02 §2's runSeed commit), MINIGAME_SUBMIT (03 §6's minigame resolution), ROLL_DICE and " +
            "USE_REROLL (04 §§1,3-4) — have a handler. Lower this by exactly the number of rows that " +
