...
public sealed class CommandVocabularyTests
{
    ...
    public void Every_command_in_the_vocabulary_is_applied_and_refused_rather_than_thrown()
    {
        ...
        // BEGIN_SESSION — M3-15 lowered it again to 47 by START_RUN, and M3-08 lowered it to 45 by
        // SHOP_BUY/SHOP_REFRESH. It is stated as "the registry minus the handled rows" rather than
        // as the literal 45 so the next task to land a handler lowers it by construction, and so
        // the number can never drift below what the loop can reach: an equality against a computed
        ...
        deferred.ShouldBe(
            ...
            "every DEFERRED row of 14 §2.3 is driven here — 45 of the 49 since M3-08 landed the " +
        ...
        deferred.ShouldBe(
            ...
            "(02 §2's runSeed commit), and SHOP_BUY/SHOP_REFRESH (03 §7's shop, M3-08) — have a " +
