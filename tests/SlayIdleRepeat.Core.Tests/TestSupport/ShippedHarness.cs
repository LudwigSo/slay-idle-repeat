...
/// <summary>
/// The shipped <c>game-data</c> tree, loaded once for the whole suite. Sharing is safe because a
/// <see cref="Core.Content.ContentSnapshot"/> is immutable; every negative case builds its own
/// snapshot through <c>GameDataLoader.LoadWith</c>.
/// </summary>
