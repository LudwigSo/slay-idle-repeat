...
| M1 | Core domain skeleton & `InMemoryGame` | 1 | 🔄 **implementation complete, awaiting review** — 13/13 merged to `milestone/M1` (2026-08-13). Clean Release build 0/0 · unit **1961** · architecture **67/67** · content validation pass. Exit criteria not yet verified; that is `milestone-review`'s |
