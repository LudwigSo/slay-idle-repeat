...
**Post-review state:** build 0/0 (Debug + Release) · unit group **1079** · Contract **24** · Architecture **38/38** · Integration **3/3** · content validation, vendor uniqueness and no-cloud-credentials all pass.
