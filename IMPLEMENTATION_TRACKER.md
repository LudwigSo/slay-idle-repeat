...
| M2-09 | `ResolveAttack` 10-step pipeline; ward pool (cap, absorption order, bypass list); `Heal()` + overheal; `ReflectDamage`; `AttackMultiplier` transient | 05 §4 | 🔄 wave 5 · `feature-M2-09-damage-resolution` |
| M2-10 | 12 status effects + the DoT/HoT cadence engine (anchoring, stacking, mitigation exemptions) | 05 §5 | 🔄 wave 5 · `feature-M2-10-status-effects` |
...
| M2-14 | PvP duel mode in the same code path: `IS_PVP` semantics, attacker-first initiative, no `ON_KILL`, 60 s cap, tie rules | 05 §3.3, 11 §6 | 🔄 wave 5 · `feature-M2-14-pvp-duel` |
