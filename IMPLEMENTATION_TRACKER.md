...
| M1-08 | `AdvanceTime` lazy catch-up: energy regen accrual, 05:00 UTC daily resets, weekly boundaries, Plus expiry — first step of every handler. Boundaries whose state does not exist yet (event windows, ad caps, dungeon entries, quest expiry, daily-shop stock) go in the gap register, not into invented state | 30 §2.3 | 🔄 dispatched wave 8 · `feature-M1-08-advance-time` |
