...
| M1-11 | `InMemoryGame(ContentSnapshot, seed, VirtualClock)` + `VirtualClock` harness; perf target: 180-day player < 200 ms | 30 §6 | 🔄 dispatched wave 10 · `feature-M1-11-in-memory-game` |
