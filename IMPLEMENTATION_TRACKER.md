...
| M2-13 | All 8 boss scripts + `BOSS_FTUE` authored as DSL data in **`game-data/content/bosses/`** + schema (coefficient rows from `17` §1.2 + mechanics). Closes 1 📐-baseline entry | 17 §2–9 | 🔄 wave 6 · `feature-M2-13-boss-scripts` |
