...
| M0-06 | `Core/Rng`: `Hash64` (xxHash64, pinned encoding) + committed reference-vector table; `DeterministicRng` counter-based streams (`WeightedPick` = one draw) | 14 §8.0–8.1 | 🔄 `feature-M0-06-core-rng` |
