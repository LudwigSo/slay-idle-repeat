...
**Packet 5 of 7 — generated from `docs/SCREEN_DESIGN_BRIEF.md`, do not edit by hand.**

This packet covers **S20 Arena, S21 PvP Loadout, S22 Leaderboard, S33-S36 Guilds**. Everything below the token slot is the shared constraint set, identical in
