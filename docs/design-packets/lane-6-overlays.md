...
**Packet 7 of 7 — generated from `docs/SCREEN_DESIGN_BRIEF.md`, do not edit by hand.**

This packet covers **the 17 unnumbered surfaces**. Everything below the token slot is the shared constraint set, identical in
