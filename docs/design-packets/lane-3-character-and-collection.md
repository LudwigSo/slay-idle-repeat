# Lane 3 · Character and collection

**Packet 4 of 7 — generated from `docs/SCREEN_DESIGN_BRIEF.md`, do not edit by hand.**

This packet covers **S15 Hero, S16 Inventory, S17 Forge, S18 Talents, S19 Menagerie**. Everything below the token slot is the shared constraint set, identical in
