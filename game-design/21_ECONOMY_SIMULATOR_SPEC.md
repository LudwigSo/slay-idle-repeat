...
| **LOW** (12) | `AD_REROLL_PERK`, `AD_EXTRA_PERK_CHOICE`, `AD_FIXED_DIE`, `AD_SHOP_REFRESH`, `AD_SHOP_FREEBIE`, `AD_SKIP_CURSE`, `AD_RETRY_MINIGAME`, `AD_CAMPFIRE_HEAL`, `AD_EXTRA_DUEL`, `AD_SHOP_REDRAW`, `AD_FREE_RETRY`, `AD_ENHANCE_LUCK` |
